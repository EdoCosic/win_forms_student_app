...
namespace FIT.WinForms.IspitIB210181
{
    public partial class frmProstorijeIB210181 : Form
    {
        ...
        {
            frmNovaProstorijaIB210181 frmNovaProsotorija = new frmNovaProstorijaIB210181();
            if (frmNovaProsotorija.ShowDialog() == DialogResult.OK)
            {
                UcitajProstorije();
            }
        }
        ...
        private void dgvProstorije_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            {
                frmNovaProstorijaIB210181 frmNovaProsotorija = new frmNovaProstorijaIB210181(odabranaProstorija);
                if (frmNovaProsotorija.ShowDialog() == DialogResult.OK)
                {
                    UcitajProstorije();
                }
